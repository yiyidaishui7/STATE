...
# 配置
# ============================================
CONFIG_PATH="configs/baseline_config_strict.toml"
OUTPUT_DIR="results/baseline_strict_$(date +%Y%m%d_%H%M%S)"
PROJECT_DIR="./"
...
echo "训练配置"
echo "=========================================="
echo "训练集: K562 + Jurkat + RPE1 (完全)"
echo "验证集: HepG2 (完全，zero-shot)"
if [ "$HAS_H1" = true ]; then
    echo "测试集: H1"
fi
echo ""
echo "参数:"
echo "  - Max steps: 40000"
echo "  - Validation freq: 200"
echo "  - Checkpoint freq: 2000"
echo "  - Model: state_sm"
echo ""
...
uv run state tx train \
  ...
  model=state_sm \
  wandb.tags="[baseline_strict,zero_shot,dg_experiment]" \
  wandb.project=baseline_dg_strict \
