...
# VAL_DATA_PATH = f"{DATA_ROOT}/hepg2.h5ad"
...
def run_inference(ckpt, input_adata):
    ...
    # ==========================================
    env = os.environ.copy()
    env["CUDA_VISIBLE_DEVICES"] = "1"  # <--- 强制使用 1 号卡
...
if __name__ == "__main__":
    print(f"🚀 [Score V4] 启动训练 (Baseline: DES={BASELINE_DES}, PDS={BASELINE_PDS}, MAE={BASELINE_MAE})...")
    ...
    # === 2. 启动训练进程 (强制使用 GPU 0) ===
    # 这样可以防止训练进程抢占 GPU 1 的显存，留给推理进程专用
    ...
    if process.poll() is not None:
        ...
        print("✅ 训练进程 (GPU 0) 运行中... 监控脚本 (GPU 1) 准备就绪。")
